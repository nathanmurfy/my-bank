...
public abstract class AbstractAccount {
	...
	public Double withdraw(double amount) throws InusfficentFundsException, UnsupportedOperationException {
		this.balance -= amount;
	...
	public void checkAmountIsGreaterThanZeroElseThrow(double amount)
	...
	public void checkForSufficientFundsElseThrow(double amount)
			throws InusfficentFundsException {
		if (amount > this.balance) {
			throw new InusfficentFundsException("Insufficient funds: "
